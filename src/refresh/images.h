...
typedef enum {
    ...
    IF_OPAQUE           = BIT(2),   // known to be opaque
    IF_PALETTED         = BIT(3),   // loaded from 8-bit paletted format
    ...
    IF_DEFAULT_FLARE    = BIT(8),   // default flare hack
    IF_CUBEMAP          = BIT(9),   // cubemap (or part of it)
    IF_CLASSIC_SKY      = BIT(10),  // split in two halves
