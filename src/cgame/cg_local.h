...
typedef struct {
    ...
    centity_t       *solid_entities[MAX_PACKET_ENTITIES];
    ...
    bool        third_person_view;
    float       third_person_alpha;
    ...
    vec3_t      player_entity_origin;
    vec3_t      player_entity_angles;
...
void CG_MuzzleFlash(centity_t *ent, player_muzzle_t weapon);
